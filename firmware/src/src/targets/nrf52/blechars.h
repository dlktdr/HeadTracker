...
extern float bt_rotx;
extern float bt_roty;
extern float bt_rotz;
...
extern struct bt_uuid_16 bt_uuid_rotx;
extern struct bt_uuid_16 bt_uuid_roty;
extern struct bt_uuid_16 bt_uuid_rotz;
...
#define AUTOGENERATED_CHARACTERISTICS \
    ...
    ,BT_GATT_CHARACTERISTIC(&bt_uuid_rotx.uuid, BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE, \
                                                   BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, \
                                                   btrd_rotx, btwr_rotx, (void*)&bt_rotx) \
    ,BT_GATT_CHARACTERISTIC(&bt_uuid_roty.uuid, BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE, \
                                                   BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, \
                                                   btrd_roty, btwr_roty, (void*)&bt_roty) \
    ,BT_GATT_CHARACTERISTIC(&bt_uuid_rotz.uuid, BT_GATT_CHRC_READ | BT_GATT_CHRC_WRITE, \
                                                   BT_GATT_PERM_READ | BT_GATT_PERM_WRITE, \
                                                   btrd_rotz, btwr_rotz, (void*)&bt_rotz) \
