...
public:
  ...
  // Tilt Output Channel
  inline const uint8_t& getTltCh() {return tltch;}
  ...
  // Roll Output Channel
  inline const uint8_t& getRllCh() {return rllch;}
  ...
  // Pan Output Channel
  inline const uint8_t& getPanCh() {return panch;}
  ...
  inline const uint8_t& getAlertCh() {return alertch;}
  ...
  // PWM 0 Channel
  inline const uint8_t& getPwm0() {return pwm0;}
  ...
  // PWM 1 Channel
  inline const uint8_t& getPwm1() {return pwm1;}
  ...
  // PWM 2 Channel
  inline const uint8_t& getPwm2() {return pwm2;}
  ...
  // PWM 3 Channel
  inline const uint8_t& getPwm3() {return pwm3;}
  ...
  // Analog 0 Channel
  inline const uint8_t& getAn0Ch() {return an0ch;}
  ...
  // Analog 1 Channel
  inline const uint8_t& getAn1Ch() {return an1ch;}
  ...
  // Analog 2 Channel
  inline const uint8_t& getAn2Ch() {return an2ch;}
  ...
  // Analog 3 Channel
  inline const uint8_t& getAn3Ch() {return an3ch;}
  ...
  inline const uint8_t& getAux0Ch() {return aux0ch;}
  bool setAux0Ch(uint8_t val=0) {
    if(val >= -1 && val <= MAX_CHANNELS) {
      aux0ch = val;
      return true;
    }
  ...
  inline const uint8_t& getAux1Ch() {return aux1ch;}
  bool setAux1Ch(uint8_t val=0) {
    if(val >= -1 && val <= MAX_CHANNELS) {
      aux1ch = val;
      return true;
    }
  ...
  inline const uint8_t& getAux2Ch() {return aux2ch;}
  bool setAux2Ch(uint8_t val=0) {
    if(val >= -1 && val <= MAX_CHANNELS) {
      aux2ch = val;
      return true;
    }
  ...
  inline const uint8_t& getRstPpm() {return rstppm;}
  bool setRstPpm(uint8_t val=0) {
    if(val >= -1 && val <= MAX_CHANNELS) {
      rstppm = val;
      return true;
    }
...
protected:
  ...
  uint8_t aux0ch = 0; // Auxilary Function 0 Channel
  uint8_t aux1ch = 0; // Auxilary Function 1 Channel
  uint8_t aux2ch = 0; // Auxilary Function 2 Channel
  uint8_t rstppm = 0; // Reset Center on PPM Input Channel
