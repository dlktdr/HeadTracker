...
public:
  ...
  // Enable LZ4 Compression of Data Stream
  inline const bool& getLz4Comp() {return lz4comp;}
  void setLz4Comp(bool val=false) { lz4comp = val; }
  ...
  void loadJSONSettings(DynamicJsonDocument &json) {
    ...
    v = json["lz4comp"]; if(!v.isNull()) {setLz4Comp(v);}
...
protected:
  ...
  bool lz4comp = false; // Enable LZ4 Compression of Data Stream
