...
public:
    ...
    QObject(parent)
  {
    ...
    descriptions["lz4comp"] = "Enable LZ4 Compression of Data Stream";
  ...
  bool getLz4Comp() {return _setting["lz4comp"].toBool();}
  void setLz4Comp(bool val=false) { _setting["lz4comp"] = val; }
